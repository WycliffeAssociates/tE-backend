...
urlpatterns = [
    ...
    url(r'^upload/(?P<filename>[^/]+)$', views.file_upload.FileUploadView.as_view()),
    ...
    url(r'^get_source/$', views.source_file.SourceFileView.as_view()),
    url(r'^zip_project_files/$', views.zip_project_files.ZipProjectFiles.as_view()),
